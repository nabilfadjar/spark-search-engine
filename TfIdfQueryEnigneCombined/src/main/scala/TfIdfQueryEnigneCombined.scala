...
object TfIdfQueryEnigneCombined {
    def main(args: Array[String]) {
        ...
        if(query_size.value == 1){
            ...
            // Save Results in HDFS
            sc.parallelize(posts_filter_cos_sort).saveAsTextFile(result_loc + "/search_results_id_2")
            ...
            posts_filter_cos_sort_xml.saveAsTextFile(result_loc + "/search_results_xml_2")
